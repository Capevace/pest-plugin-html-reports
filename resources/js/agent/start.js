...
// Get the test case json data from the argv
const testCaseJson = process.argv[2];

// Parse the json data
const testCase = {
	name: 'it renders the dashboard',
	description: 'it renders the dashboard',
	test: 'it renders the dashboard',
	issues: null,
	todo: null,
	assignees: null,
	prs: null,
